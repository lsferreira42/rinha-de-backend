...
RESULTS_DIR="/Users/leandroferreira/code/rinha-de-backend/.gatling/user-files/results"
OUTPUT_REPORT="/Users/leandroferreira/code/rinha-de-backend/.gatling/user-files/results/gatling-text-report.txt"
